...
import type { AutoStatus, GhState } from "./types.js";
...
/**
 * Derive the breeze_status field. Pure function — input-only.
 */
export function classifyAutoStatus(input: ClassifierInput): AutoStatus {
