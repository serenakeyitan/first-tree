...
import {
  resolveAutoPackageRoot,
  spawnInherit,
  type SpawnFn,
} from "../src/bridge.js";

describe("resolveAutoPackageRoot", () => {
  it("returns a directory that contains the @first-tree/auto package.json", () => {
    const root = resolveAutoPackageRoot();
